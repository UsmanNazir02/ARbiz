            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    <h1 className="text-3xl font-extrabold text-indigo-600 tracking-tight">
                        {id ? 'Customize Your AR Business Card' : 'Create New AR Business Card'}
                    </h1>
                    <p className="mt-2 text-lg text-gray-600">
                        Design your professional digital business card with augmented reality features
                    </p>
                </div>
                ...
                <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-0">
                        ...
                        <div className="lg:col-span-3 p-8">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="bg-indigo-50 p-4 rounded-lg mb-6">
                                    <h2 className="text-xl font-semibold text-indigo-700 mb-2">Card Information</h2>
                                ...
                                <div className="bg-indigo-50 p-4 rounded-lg mb-6">
                                    <h2 className="text-xl font-semibold text-indigo-700 mb-2">Contact Details</h2>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                ...
                                <div className="bg-indigo-50 p-4 rounded-lg mb-6">
                                    <h2 className="text-xl font-semibold text-indigo-700 mb-2">Card Appearance</h2>
                                ...
                                <div className="flex justify-between pt-4 border-t border-gray-200">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className={`py-2 px-6 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                                    >
                                        {loading ? (
                                            ...
                                            <span>{id ? 'Update Card' : 'Create Card'}</span>
                                        )}
                                    </button>
                                </div>
                            </form>
                        ...
                        <div className="lg:col-span-2 bg-gray-50 p-8 border-l border-gray-200 flex flex-col">
                            <h3 className="text-xl font-semibold text-indigo-700 mb-6 text-center">Live Card Preview</h3>
